...
<html>
    ...
    <body>
    	...
    	<div class="container">
    		<div class="col-md-4">
    			<div id="mylogo">
	    			...
	    			<div><i id="mylogowen2">热爱编程&nbsp;&nbsp;&nbsp; 热爱生活&nbsp;&nbsp;&nbsp;热爱JUNGLE</i></div>
	    		</div>
    		...
    		<div class="login panel-default " >
    			<div class="panel-heading">
    				<h4 style="margin-left: 130px;">JUNGLE论坛欢迎登陆</h4>
    			</div>
    			<div class="panel-body col-xs-12">
	    			...
	    			<div class="input-group col-xs-6" style="margin-top: 0px;">
	    				<input type="submit" id="submit" class="btn btn-success btn-sm btn-block" value="登&nbsp;&nbsp;陆">
	    			</div>
    			</div>
        ...
        document.onmouseup = function(e){
        	...
        	//表单提交检查
        	function checkForm(){
        		if(checkUsername() && checkPassword()&&drag_flag){return true;}
        		alert(checkUsername()+" "+checkPassword()+""+drag_flag);
        		return false;
        	}
        	//用户名错误信息展示
        	...
        	//未通过验证,错误信息检查
        	function check(){
        		var username = '${msg.usernameMsg}';
        		var password = '${msg.passwordMsg}';
        		if(username !=""){
        			if(username == "false"){
        				openUserError();
        				return null;
