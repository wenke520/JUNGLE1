  ...
  <body>
	  	...
	  	<form action = "" method = "get">																	<!-- 数据提交地址 -->
		  	<table class="message">
				<tr><td>昵称</td><td><input class="form-control"  type = "text" name = "uname" value = "" /></td></tr>				<!-- 数据库 -->
		 		...
		 		<tr><td>生日</td><td><input class="form-control" type = "text" name = "birth" value = "" /></td></tr>				<!-- 数据库 -->
		  	...
		  	<input id = "h_bgPath" type = "hidden" name = "bg" value = "images/bg.jpg">									<!-- 背景图地址 -->
	  	</form> 
   ...
   <div id="picWall" >
    ...
    <div  id="bgWall">
	   		...
	   		<img src="images/bg.jpg" ondblclick = "select_bg(this)" />
			<img src="images/bg2.jpeg" ondblclick = "select_bg(this)"/>
			<img src="images/bg15.jpg" ondblclick = "select_bg(this)" /><br />
			<img src="images/bg16.jpg" ondblclick = "select_bg(this)" />
			<img src="images/bg5.jpg" ondblclick = "select_bg(this)" />
			<img src="images/bg17.jpg" ondblclick = "select_bg(this)" /><br />
			<img src="images/bg23.jpg" ondblclick = "select_bg(this)"/>
			<img src="images/bg8.jpg" ondblclick = "select_bg(this)"/>
			<img src="images/bg20.jpg" ondblclick = "select_bg(this)" /><br />
			<img src="images/bg10.jpg" ondblclick = "select_bg(this)"/>
			<img src="images/bg11.jpg"  ondblclick = "select_bg(this)"/>
			<img src="images/bg12.jpg"  ondblclick = "select_bg(this)"/><br />
